...
/**
 * Copy From Spring Security Oauth2 Client Adapter class to convert
 * {@link OAuth2ClientProperties} to a {@link ClientRegistration}.
 *
 * @author Phillip Webb
...
public final class OAuth2ClientPropertiesRegistrationAdapter {
	...
	private static ClientRegistration getClientRegistration(String registrationId,
		...
		ClientRegistration.Builder builder = getBuilderFromIssuerIfPossible(registrationId, properties.getProvider(),
				providers);
		if (builder == null) {
