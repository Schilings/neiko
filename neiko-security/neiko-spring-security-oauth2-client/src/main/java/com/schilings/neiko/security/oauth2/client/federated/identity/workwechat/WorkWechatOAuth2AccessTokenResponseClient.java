...
public class WorkWechatOAuth2AccessTokenResponseClient
	...
	public WorkWechatOAuth2AccessTokenResponseClient() {
		...
		tokenResponseHttpMessageConverter
				.setAccessTokenResponseConverter(new WorkWechatOAuth2AccessTokenResponseConverter());
		...
		tokenResponseClient
				.setRequestEntityConverter(new WorkWechatOAuth2AuthorizationCodeGrantRequestEntityConverter());
	...
	public OAuth2AccessTokenResponse getTokenResponse(OAuth2AuthorizationCodeGrantRequest authorizationGrantRequest) {
		...
		return OAuth2AccessTokenResponse.withResponse(tokenResponse)
				.additionalParameters(Collections.singletonMap(OAuth2ParameterNames.CODE, code)).build();
	}
