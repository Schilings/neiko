...
public class FederatedIdentityAuthenticationResultConverter
		implements Converter<OAuth2LoginAuthenticationToken, OAuth2AuthenticationToken> {
	...
	private OAuth2UserMerger oidcUserHandler = (authenticationToken) -> this.oauth2UserMerger
			.merge(authenticationToken);
