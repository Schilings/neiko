...
public final class FederatedIdentityConfigurer
	...
	/**
	 * @param authorizationRequestUri The authorization request URI for initiating the
	 * login flow with an external IDP, defaults to
	...
	public String getFilterProccessUri() {
		return filterProccessUri;
	}
	...
	public FederatedIdentityConfigurer authorizationRequestRepository(
	...
	public FederatedIdentityConfigurer authorizationRequestCustomizer(
			OAuth2AuthorizationRequestCustomizer authorizationRequestCustomizer) {
		this.authorizationRequestCustomizer = authorizationRequestCustomizer;
		return this;
	}

	public FederatedIdentityConfigurer authorizationRequestResolver(
			OAuth2AuthorizationRequestResolver authorizationRequestResolver) {
		this.authorizationRequestResolvers.add(authorizationRequestResolver);
		return this;
	}

	public FederatedIdentityConfigurer accessTokenResponseClient(
	...
	public void init(HttpSecurity http) throws Exception {
		...
		DelegatingOAuth2AuthorizationRequestResolver resolver = new DelegatingOAuth2AuthorizationRequestResolver(
				this.authorizationRequestResolvers, defaultResolver);
		...
		this.accessTokenResponseClient = new DelegatingOAuth2AccessTokenResponseClient(this.accessTokenResponseClients,
				defaultTokenResponseClient);
	...
	public void configure(HttpSecurity httpSecurity) throws Exception {
		...
		// 而且这一步恰巧在 this.successHandler.onAuthenticationSuccess(request, response,
		// authResult);前
