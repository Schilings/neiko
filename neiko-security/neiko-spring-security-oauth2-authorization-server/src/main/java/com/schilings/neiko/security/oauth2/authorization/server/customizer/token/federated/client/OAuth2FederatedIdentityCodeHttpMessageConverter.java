 ...
 * @author Schilings
*/
public class OAuth2FederatedIdentityCodeHttpMessageConverter extends AbstractHttpMessageConverter<OAuth2FederatedIdentityCode> {
    ...
    @Override
    protected OAuth2FederatedIdentityCode readInternal(Class<? extends OAuth2FederatedIdentityCode> clazz, HttpInputMessage inputMessage) throws IOException, HttpMessageNotReadableException {
        try {
    ...
    @Override
    protected void writeInternal(OAuth2FederatedIdentityCode code, HttpOutputMessage outputMessage) throws IOException, HttpMessageNotWritableException {
        try {
    ...
    private static class OAuth2FederatedIdentityCodeConverter implements Converter<Map<String, Object>, OAuth2FederatedIdentityCode> {
    ...
    private static class OAuth2FederatedIdentityParametersConverter implements Converter<OAuth2FederatedIdentityCode, Map<String, Object>> {
    ...
    private static long getParameterValue(Map<String, Object> parameters, String parameterName,
                                          long defaultValue) {
