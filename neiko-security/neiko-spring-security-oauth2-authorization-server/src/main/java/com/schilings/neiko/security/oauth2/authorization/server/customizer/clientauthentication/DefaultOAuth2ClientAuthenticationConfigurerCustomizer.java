...
public class DefaultOAuth2ClientAuthenticationConfigurerCustomizer extends OAuth2ClientAuthenticationConfigurerCustomizer {
    @Override
    public void customize(OAuth2AuthorizationServerConfigurer authorizationServerConfigurer, HttpSecurity httpSecurity) throws Exception {
