...
public class OAuth2TokenEndpointExtensionGrantTypeCustomizer extends OAuth2TokenEndpointConfigurerCustomizer {
	...
	public OAuth2TokenEndpointExtensionGrantTypeCustomizer converterExpander(AuthenticationConverterExpander expander) {
	...
	public OAuth2TokenEndpointExtensionGrantTypeCustomizer providerExpander(AuthenticationProviderExpander expander) {
	...
	public OAuth2TokenEndpointExtensionGrantTypeCustomizer oauth2TokenResponseEnhancer(
			OAuth2TokenResponseEnhancer enhancer) {
		this.oauth2TokenResponseEnhancer = enhancer;
		return this;
	}

	public OAuth2TokenEndpointExtensionGrantTypeCustomizer accessTokenResponseHandler(
			Function<AuthenticationSuccessHandler, AuthenticationSuccessHandler> apply) {
		this.successHandlerMapping = apply;
		return this;
	}

	public OAuth2TokenEndpointExtensionGrantTypeCustomizer errorResponseHandler(
