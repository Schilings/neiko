...
import com.schilings.neiko.security.oauth2.authorization.server.filter.PasswordDecoderFilter;
...
public class OAuth2PasswordDecoderConfigurer
		extends OAuth2AuthorizationServerExtensionConfigurer<OAuth2PasswordDecoderConfigurer, HttpSecurity> {

	private final String passwordSecretKey;

	private RequestMatcher requestMatcher;

	public OAuth2PasswordDecoderConfigurer(String passwordSecretKey) {
	...
	public void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.addFilterAfter(postProcess(new PasswordDecoderFilter(requestMatcher, passwordSecretKey)),
