...
public final class OAuth2ParameterValidator {
	...
	public static void validateRedirectUri(String requestedRedirectUri, RegisteredClient registeredClient) {
		if (StringUtils.hasText(requestedRedirectUri)) {
			...
			if (requestedRedirectHost == null || requestedRedirectHost.equals("localhost")) {
				...
				// function similarly to loopback IP redirects described in Section
				// 10.3.3,
	...
	private static void throwError(String errorCode, String parameterName, RegisteredClient registeredClient) {
