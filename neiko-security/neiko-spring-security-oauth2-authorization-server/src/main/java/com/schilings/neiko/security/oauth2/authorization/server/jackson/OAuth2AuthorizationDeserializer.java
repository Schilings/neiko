...
public class OAuth2AuthorizationDeserializer extends JsonDeserializer<OAuth2Authorization> {
    @Override
    public OAuth2Authorization deserialize(JsonParser parser, DeserializationContext ctxt) throws IOException, JacksonException {
    ...
    private OAuth2Authorization deserialize(JsonParser parser, ObjectMapper mapper, JsonNode root)
        ...
        RegisteredClient client = OAuth2ComponentUtils.getRegisteredClientRepository().findById(JsonNodeUtils.findStringValue(root, "registeredClientId"));
        ...
        Map<String, Object> attributes = JsonNodeUtils.findValue(root, "attributes", JsonNodeUtils.STRING_OBJECT_MAP, mapper);
        ...
        if (StringUtils.hasText(authorizationCodeValue)) {
            ...
            Map<String, Object> authorizationCodeMetadata = JsonNodeUtils.findValue(root,"authorizationCodeMetadata",JsonNodeUtils.STRING_OBJECT_MAP, mapper);
        ...
        if (StringUtils.hasText(accessTokenValue)) {
            ...
            Map<String, Object> accessTokenMetadata = JsonNodeUtils.findValue(root,"accessTokenMetadata",JsonNodeUtils.STRING_OBJECT_MAP, mapper);

            OAuth2AccessToken.TokenType tokenType = null;
            if (OAuth2AccessToken.TokenType.BEARER.getValue().equalsIgnoreCase(JsonNodeUtils.findStringValue(root,"accessTokenType"))) {
        ...
        if (StringUtils.hasText(oidcIdTokenValue)) {
            ...
            Map<String, Object> oidcTokenMetadata = JsonNodeUtils.findValue(root,"oidcIdTokenMetadata",JsonNodeUtils.STRING_OBJECT_MAP, mapper);
        ...
        if (StringUtils.hasText(refreshTokenValue)) {
            ...
            Map<String, Object> refreshTokenMetadata = JsonNodeUtils.findValue(root,"refreshTokenMetadata",JsonNodeUtils.STRING_OBJECT_MAP, mapper);
    ...
    private OAuth2Authorization.Builder getBuilder(JsonParser parser, RegisteredClient registeredClient) throws JsonParseException {
