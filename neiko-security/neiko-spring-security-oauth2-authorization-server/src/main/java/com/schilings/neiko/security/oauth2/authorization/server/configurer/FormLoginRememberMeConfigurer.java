...
public class FormLoginRememberMeConfigurer extends 
        OAuth2AuthorizationServerExtensionConfigurer<FormLoginRememberMeConfigurer,HttpSecurity> {
    ...
    public void init(HttpSecurity httpSecurity) throws Exception {
        ...
        //那么其SecurityContextHolder就不会设置认证的Authentication (SecurityContextHolderAwareRequestFilter)
