...
class DefaultExtensionConfigurerAutoConfiguration {
	 ...
	 */
	// @Bean
	// @ConditionalOnProperty(prefix = OAuth2AuthorizationServerProperties.PREFIX, name =
	// "login-captcha-enabled",
	// havingValue = "true", matchIfMissing = true)
	// public OAuth2LoginCaptchaConfigurer oAuth2LoginCaptchaConfigurer(CaptchaValidator
	// captchaValidator) {
