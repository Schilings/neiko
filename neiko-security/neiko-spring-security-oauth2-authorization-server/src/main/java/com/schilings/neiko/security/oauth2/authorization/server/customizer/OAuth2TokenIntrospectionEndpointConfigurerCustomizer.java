...
public abstract class OAuth2TokenIntrospectionEndpointConfigurerCustomizer
	...
	public void customize(OAuth2AuthorizationServerConfigurer oAuth2AuthorizationServerConfigurer,
		...
		oAuth2AuthorizationServerConfigurer
				.tokenIntrospectionEndpoint(tokenIntrospection -> customize(tokenIntrospection, httpSecurity));
	}
