...
public class OAuth2AuthorizationSerializer extends JsonSerializer<OAuth2Authorization> {
    ...
    public void serialize(OAuth2Authorization authorization, JsonGenerator gen, SerializerProvider serializers) throws IOException {
        ...
        gen.writeStringField("authorizedScopes", StringUtils.collectionToDelimitedString(authorization.getAuthorizedScopes(), ","));
        ...
        if (authorizationCode != null) {
            ...
            if (authorizationCode.getToken().getIssuedAt() != null) {
                gen.writeStringField("authorizationCodeIssuedAt", authorizationCode.getToken().getIssuedAt().toString());
            }
            if (authorizationCode.getToken().getExpiresAt() != null) {
                gen.writeStringField("authorizationCodeExpiresAt", authorizationCode.getToken().getExpiresAt().toString());
            }
    ...
    @Override
    public void serializeWithType(OAuth2Authorization value, JsonGenerator gen, SerializerProvider serializers, TypeSerializer typeSer) throws IOException {
