...
/**
 * OAuth2 下使用的 SecurityContextRepository，从 bearerTokenResolver 中解析对应的 access_token,
 * 然后利用 oAuth2AuthorizationService 来获取对应的 SecurityContext
 */
public class OAuth2SecurityContextRepository implements SecurityContextRepository {
    ...
    public SecurityContext loadContext(HttpRequestResponseHolder requestResponseHolder) {
        ...
        Authentication authentication = (Authentication) oAuth2Authorization
