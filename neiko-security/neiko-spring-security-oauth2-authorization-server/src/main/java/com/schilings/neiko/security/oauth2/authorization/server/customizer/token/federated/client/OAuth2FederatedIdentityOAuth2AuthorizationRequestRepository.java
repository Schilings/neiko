...
/**
 * 
 * <p>为了让我们需要的信息能传递到AuthenticationSuccessHandler</p>
 * <p>让OAuth2LoginAuthenticationFilter避免直接remove掉，修改remove逻辑</p>
 * 
 * @author Schilings
*/
public class OAuth2FederatedIdentityOAuth2AuthorizationRequestRepository implements AuthorizationRequestRepository<OAuth2AuthorizationRequest> {
    ...
    public OAuth2AuthorizationRequest removeAuthorizationRequestInTheEnd(HttpServletRequest request,HttpServletResponse response) {
    ...
    private boolean isFederatedIdentityAuthorizationRequest(HttpServletRequest request, OAuth2AuthorizationRequest authorizationRequest) {
