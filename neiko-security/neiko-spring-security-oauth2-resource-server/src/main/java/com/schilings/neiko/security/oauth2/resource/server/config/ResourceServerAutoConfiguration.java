...
//        }
        ...
        @Bean
        @ConditionalOnMissingBean({JwtOAuth2ResourceServerCustomizer.class, OpaqueOAuth2ResourceServerCustomizer.class})
        ...
        public DefaultOAuth2ResourceServerCustomizer defaultOAuth2ResourceServerCustomizer(ResourceServerProperties resourceServerProperties) {
