...
public class JwtDecoderCondition extends SpringBootCondition {
	...
	public ConditionOutcome getMatchOutcome(ConditionContext context, AnnotatedTypeMetadata metadata) {
		...
		String publicKeyLocation = environment
				.getProperty("neiko.security.oauth2.resourceserver.jwt.public-key-location");
		...
		if (match) {
			...
			environment.getPropertySources()
					.addFirst(new MapPropertySource(JwtDecoderCondition.class.getSimpleName(), properties));
	...
	private void copyList(String sourceName, String targetName, ConfigurableEnvironment environment,
