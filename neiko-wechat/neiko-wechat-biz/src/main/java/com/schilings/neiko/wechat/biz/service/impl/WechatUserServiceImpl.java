...
public class WechatUserServiceImpl extends ExtendServiceImpl<WechatUserMapper, WechatUser> implements WechatUserService {
    ...
    public void synchroUser() throws WxErrorException {
        ...
        this.baseMapper.update(wxUser, Wrappers.<WechatUser>lambdaQuery()
                .eq(WechatUser::getSubscribe,WechatConst.Subscribe.YES.getValue()));
    ...
    void recursionGet(WxMpUserService wxMpUserService,String nextOpenid) throws WxErrorException {
        ...
        listWxMpUser.forEach(wxMpUser -> {
            WechatUser wxUser = baseMapper.selectOne(Wrappers.<WechatUser>lambdaQuery()
                    .eq(WechatUser::getOpenId,wxMpUser.getOpenId()));
