...
/**
 * 
 * <p>https://sa-token.dev33.cn/doc/index.html#/up/many-account</p>
 * 
 * @author Schilings
*/
public class StpOauth2UserUtil {
     ...
     * 账号体系标识 
     */
    public static final String TYPE = "oauth2user";


    /**
     * 底层的 StpLogic 对象  
     */
    public static StpLogic stpLogic = new StpOauth2Logic(TYPE);
