...
import com.schilings.neiko.extend.mybatis.plus.wrapper.join.SerializedLambda;
...
public final class LambdaUtils {
	...
	private static Map<String, ColumnCache> createColumnCacheMap(TableInfo info) {
		...
		info.getFieldList()
				.forEach(i -> map.put(formatKey(i.getProperty()), new ColumnCache(i.getColumn(), i.getSqlSelect())));
		return map;
	}
