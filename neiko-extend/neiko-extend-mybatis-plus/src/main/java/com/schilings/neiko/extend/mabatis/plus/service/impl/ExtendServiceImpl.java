package com.schilings.neiko.extend.mabatis.plus.service.impl;
...
import com.schilings.neiko.extend.mabatis.plus.service.ExtendService;
...
public class ExtendServiceImpl<M extends ExtendMapper<T>,T> implements ExtendService<T> {
     ...
     */
    @Override
    public <DTO> List<DTO> selectJoinList(Class<DTO> clazz, NeikoBaseJoin wrapper) {
