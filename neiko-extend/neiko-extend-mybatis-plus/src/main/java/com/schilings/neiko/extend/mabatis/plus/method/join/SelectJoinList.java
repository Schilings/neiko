package com.schilings.neiko.extend.mabatis.plus.method.join;


import com.baomidou.mybatisplus.core.injector.methods.SelectMaps;
import com.baomidou.mybatisplus.core.metadata.TableInfo;
import com.schilings.neiko.extend.mabatis.plus.constants.SqlMethod;
...
public class SelectJoinList extends JoinAbstractMethod{
    ...
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
         ...
         *          ${ew.sqlFirst}
         *     </if>
         *     SELECT <if test="ew.selectDistinct">DISTINCT</if>
         *     <choose>
         ...
         *     </choose>
         *     FROM tableName <if test="ew.alias != null and ew.alias != ''">${ew.alias}</if> <if test="ew.from != null and ew.from != ''">${ew.from}</if>
         *     <if test="ew != nul">
         *         <where>
        ...
        return this.addSelectMappedStatementForOther(mapperClass, sqlMethod.getMethod(), sqlSource, modelClass);
    }
