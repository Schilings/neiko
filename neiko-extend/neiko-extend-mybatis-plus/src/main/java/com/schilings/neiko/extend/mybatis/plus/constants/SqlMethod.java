package com.schilings.neiko.extend.mybatis.plus.constants;
...
public enum SqlMethod {
	...
	SELECT_JOIN_MAPS("selectJoinMapsList", "返回Map集合", "<script>\n%s SELECT %s %s FROM %s %s %s %s %s\n</script>"),
	...
	public static final List<String> collect = Arrays.stream(SqlMethod.values()).map(SqlMethod::getMethod)
