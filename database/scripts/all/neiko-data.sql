-- ----------------------------
-- Records of nk_log_access_log
-- ----------------------------
-- ----------------------------
-- Records of nk_log_login_log
-- ----------------------------
-- ----------------------------
-- Records of nk_log_operation_log
-- ----------------------------
-- ----------------------------
-- Records of nk_notify_announcement
-- ----------------------------
-- ----------------------------
-- Records of nk_notify_user_announcement
-- ----------------------------
...
VALUES (3333333333333333, 'test', '{noop}test',NULL,NULL,'TEST',
        ...
        'openid,email,phone,address,message.read,message.write,skip_password_decode,skip_captcha,authority_info,system_user_info,customer_user_info',
         0, NULL, NULL, '2022-09-17 19:41:16', NULL);
