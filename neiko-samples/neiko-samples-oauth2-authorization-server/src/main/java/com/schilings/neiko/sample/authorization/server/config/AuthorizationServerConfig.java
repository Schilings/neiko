...
public class AuthorizationServerConfig {
	...
	public DefaultOAuth2TokenEndpointConfigurerCustomizer extensionGrantTypeCustomizer() {
		...
		// handler
		extensionGrantTypeCustomizer
				.accessTokenResponseHandler(DefaultApplicationEventAuthenticationSuccessHandler::new);
	...
	public AuthorizationServerSettings authorizationServerSettings() {
		return AuthorizationServerSettings.builder()
				...
				// String)覆盖
				.tokenEndpoint("/oauth2/token").oidcUserInfoEndpoint("/oidc/userinfo").build();
	}
	...
	public RegisteredClientRepository registeredClientRepository(JdbcTemplate jdbcTemplate) {
		...
		// RegisteredClient.withId(registeredClientId1)
		...
		// 针对OIDC请求的作用域,携带"openid"说明这是个OIDC请求，如果还携带这些scope说明要获取UserInfo之类
		...
		// //OAuth2AccessTokenGenerator: 只要是OAuth2TokenType.ACCESS_TOKEN
		// 或者配置了OAuth2TokenFormat.REFERENCE 即可
		...
		// RegisteredClient.withId(registeredClientId2)
