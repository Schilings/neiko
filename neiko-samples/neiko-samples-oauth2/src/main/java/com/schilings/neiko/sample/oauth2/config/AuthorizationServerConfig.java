...
public class AuthorizationServerConfig {
	...
	public RegisteredClientRepository registeredClientRepository() {
		...
		RegisteredClient registeredClient1 = RegisteredClient.withId(registeredClientId1)
				.clientId("messaging-client111").clientSecret("{noop}secret111")
				...
				.redirectUri("http://127.0.0.1:9000/oauth2Login")
		...
		RegisteredClient registeredClient2 = RegisteredClient.withId(registeredClientId2)
				.clientId("messaging-client2222").clientSecret("{noop}secret2222")
				.clientAuthenticationMethod(ClientAuthenticationMethod.CLIENT_SECRET_POST)
				.clientAuthenticationMethod(ClientAuthenticationMethod.CLIENT_SECRET_BASIC)
				.authorizationGrantType(AuthorizationGrantType.AUTHORIZATION_CODE)
				.authorizationGrantType(AuthorizationGrantType.REFRESH_TOKEN)
