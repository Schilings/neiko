...
//        boolean hasClz = AnnotatedElementUtils.hasAnnotation(beanType, ApiVersion.class);
//        Set<Method> methods = MethodIntrospector.selectMethods(beanType, (ReflectionUtils.MethodFilter) method -> {
