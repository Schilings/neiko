...
public interface OAuth2RegisteredClientRemote {
	...
	R<PageResult<OAuth2RegisteredClientPageVO>> getRegisteredClientPage(
	 ...
	 */
	@GetExchange("/registeredClientPage")
	R<PageResult<OAuth2RegisteredClientPageVO>> getRegisteredClientPage(PageParam pageParam,
			@RequestParameterObject OAuth2RegisteredClientQO qo);
