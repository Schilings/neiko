...
@Service
public class OAuth2RegisteredClientServiceImpl extends ExtendServiceImpl<OAuth2RegisteredClientMapper, OAuth2RegisteredClient> 
    ...
    public OAuth2RegisteredClientServiceImpl(OAuth2ClientSettingsService clientSettingsService, 
                                             OAuth2TokenSettingsService tokenSettingsService, 
    ...
    public OAuth2RegisteredClient getByClientId(String clienId) {
        return baseMapper.selectOne(WrappersX.<OAuth2RegisteredClient>lambdaQueryX().eq(OAuth2RegisteredClient::getClientId, clienId));
    }
    ...
    public boolean saveRegisteredClient(OAuth2RegisteredClientDTO dto) {
        ...
        //settings处理
        OAuth2ClientSettingsDTO clientSettings = dto.getClientSettings() == null ? defaultClientSettings() : dto.getClientSettings();
        OAuth2TokenSettingsDTO tokenSettingsDTO = dto.getTokenSettings() == null ? defaultTokenSettings() : dto.getTokenSettings();
    ...
    private void entityToInfo(OAuth2RegisteredClient entity, OAuth2RegisteredClientInfo info) {
        ...
        info.setClientAuthenticationMethods(StringUtils.commaDelimitedListToSet(entity.getClientAuthenticationMethods()));
