...
public class CustomRegisteredClientRepository implements RegisteredClientRepository {
	...
	public static RegisteredClient toObject(OAuth2RegisteredClientInfo client) {
		RegisteredClient.Builder builder = RegisteredClient.withId(client.getId().toString())
				...
				.clientName(client.getClientName()).clientIdIssuedAt(client.getClientIdIssuedAt())
				.clientSecretExpiresAt(client.getClientSecretExpiresAt())
				.clientAuthenticationMethods((authenticationMethods) -> client.getClientAuthenticationMethods()
						.forEach(authenticationMethod -> authenticationMethods
								.add(resolveClientAuthenticationMethod(authenticationMethod))))
				.authorizationGrantTypes((grantTypes) -> client.getAuthorizationGrantTypes()
