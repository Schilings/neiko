...
public class CustomOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    private OAuth2Authorization toObject(Authorization entity) {
        ...
        if (StringUtils.hasText(entity.getAccessTokenValue())) {
            ...
            OAuth2AccessToken accessToken = new OAuth2AccessToken(
                    ...
                    Instant.parse(entity.getAccessTokenIssuedAt()),
                    Instant.parse(entity.getAccessTokenExpiresAt()),
                    scopes);
        ...
        if (StringUtils.hasText(entity.getRefreshTokenValue())) {
            OAuth2RefreshToken refreshToken = new OAuth2RefreshToken(
                    ...
                    Instant.parse(entity.getRefreshTokenIssuedAt()),
                    Instant.parse(entity.getRefreshTokenExpiresAt()));
        ...
        if (StringUtils.hasText(entity.getOidcIdTokenValue())) {
            OidcIdToken idToken = new OidcIdToken(
                    ...
                    Instant.parse(entity.getOidcIdTokenIssuedAt()),
                    Instant.parse(entity.getOidcIdTokenExpiresAt()),
    ...
    private void setTokenValues(
            ...
            Consumer<String> issuedAtConsumer,
            Consumer<String> expiresAtConsumer,
        ...
        if (token != null) {
            ...
            expiresAtConsumer.accept(Optional.ofNullable(oAuth2Token.getExpiresAt()).map(Instant::toString).orElse(null));
