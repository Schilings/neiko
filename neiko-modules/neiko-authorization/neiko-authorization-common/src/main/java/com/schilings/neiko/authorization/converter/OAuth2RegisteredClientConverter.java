...
public interface OAuth2RegisteredClientConverter {
    ...
    @Mappings(value = {
            @Mapping(target = "clientAuthenticationMethods", expression = "java(commaDelimitedListToSet(po.getClientAuthenticationMethods()))"),
            @Mapping(target = "authorizationGrantTypes", expression = "java(commaDelimitedListToSet(po.getAuthorizationGrantTypes()))"),
    ...
    @Mappings(value = {
            @Mapping(target = "clientAuthenticationMethods", expression = "java(collectionToCommaDelimitedString(dto.getClientAuthenticationMethods()))"),
            @Mapping(target = "authorizationGrantTypes", expression = "java(collectionToCommaDelimitedString(dto.getAuthorizationGrantTypes()))"),
            @Mapping(target = "redirectUris", expression = "java(collectionToCommaDelimitedString(dto.getRedirectUris()))"),
