...
public interface WechatMpReplyMapper extends ExtendMapper<WechatMpReply> {
	...
	default PageResult<WechatMpReplyPageVO> queryPage(PageParam pageParam, WechatMpReplyQO qo) {
		...
		NeikoLambdaQueryWrapper<Object> queryWrapper = WrappersX.lambdaQueryJoin().selectAll(WechatMpReply.class)
		...
		IPage<WechatMpReplyPageVO> voPage = this.selectJoinPage(page, WechatMpReplyPageVO.class, AUTO_RESULT_MAP,
				queryWrapper);
