...
public abstract class NettyRemotingAbstract {
	 ...
	 * 映射缓存所有正在进行的请求
	 */
	protected final ConcurrentMap<Integer, ResponseFuture> responseTable = new ConcurrentHashMap<Integer, ResponseFuture>(
			256);
	...
	public void processRequestCommand(final ChannelHandlerContext ctx, final RemotingCommand cmd) {
		...
		if (pair != null) {
			...
			final RemotingCommand response = RemotingCommandHelper
