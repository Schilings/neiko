...
public class RemotingCommand {
    ...
    private static final Map<Class<? extends CommandHeaderCustomizer>, Field[]> CLASS_HASH_MAP =
            new HashMap<Class<? extends CommandHeaderCustomizer>, Field[]>();
    ...
    /**
     * 序列化报文头部信息 
     * 实际报文头部信息=指定序列化方式序列化RemotingCommand的结果
     * @return
     */
    ...
    /**
     * 序列化报文
     * 整个报文组成：长度(4，头部长度+内容长度，不包括这4个字节) 报文头长度(4) 报文头内容(..) 报文内容(..)
