 ...
 *
 * <p>
 * 本端发起的请求结果Future，即本地此次请求是否发送成功等信息
 * </p>
 * <p>
 * 若发送成功，则拿到的远程响应
 * </p>
...
public class ResponseFuture {
	...
	public String toString() {
		return "ResponseFuture [responseCommand=" + responseCommand + ", sendRequestOK=" + sendRequestOK + ", cause="
				+ cause + ", opaque=" + opaque + ", processChannel=" + processChannel + ", timeoutMillis="
				+ timeoutMillis + ", invokeCallback=" + invokeCallback + ", beginTimestamp=" + beginTimestamp
