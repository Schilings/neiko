...
/**
 * <p>
 * By default, file region are directly transferred to socket channel which is known as
 * zero copy. In case we need to encrypt transmission, data being sent should go through
 * the {@link SslHandler}. This encoder ensures this process.
 * </p>
 */
public class FileRegionEncoder extends MessageToByteEncoder<FileRegion> {
	 ...
	 * {@link MessageToByteEncoder} belongs to
