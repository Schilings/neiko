...
public class RemotingCommandTest {
    ...
    public void testMarkProtocolType_JSONProtocolType() {
        int source = 261; //0000 0001 0000 0101
        SerializeType type = SerializeType.JSON; // (0000 0000) (0000 0000) (0000 0001) (0000 0101)
        byte[] result = RemotingCommandHelper.markProtocolType(source, type);
        assertThat(result).isEqualTo(new byte[] {0, 0, 1, 5});
    }

    @Test
    public void testMarkProtocolType_NEIKOProtocolType() {
        int source = 16777215;
        SerializeType type = SerializeType.NEIKO;
        byte[] result = RemotingCommandHelper.markProtocolType(source, type);
    ...
    public void testCreateRequestCommand_RegisterBroker() {
        ...
        CommandHeaderCustomizer header = new SampleCommandCustomHeader();
        RemotingCommand cmd = RemotingCommandHelper.createRequestCommand(code, header);
    ...
    public void testCreateResponseCommand_SuccessWithHeader() {
        ...
        RemotingCommand cmd = RemotingCommandHelper.createResponseCommand(code, remark, SampleCommandCustomHeader.class);
        assertThat(cmd.getCode()).isEqualTo(code);
        assertThat(cmd.getVersion()).isEqualTo(2333);
    ...
    public void testCreateResponseCommand_SuccessWithoutHeader() {
        ...
        int code = RemotingSysResponseCode.SUCCESS;
        String remark = "Sample remark";
        RemotingCommand cmd = RemotingCommandHelper.createResponseCommand(code, remark);
        assertThat(cmd.getCode()).isEqualTo(code);
        assertThat(cmd.getVersion()).isEqualTo(2333);
        assertThat(cmd.getRemark()).isEqualTo(remark);
        assertThat(cmd.getFlag() & 0x01).isEqualTo(1); //flag bit 0: 1 presents response
    ...
    public void testCreateResponseCommand_FailToCreateCommand() {
        ...
        int code = RemotingSysResponseCode.SUCCESS;
        String remark = "Sample remark";
        RemotingCommand cmd = RemotingCommandHelper.createResponseCommand(code, remark, CommandHeaderCustomizer.class);
    ...
    public void testCreateResponseCommand_SystemError() {
        ...
        RemotingCommand cmd = RemotingCommandHelper.createResponseCommand(SampleCommandCustomHeader.class);
    ...
    public void testEncodeAndDecode_EmptyBody() {
        ...
        try {
            decodedCommand = RemotingCommandHelper.decode(buffer);
    ...
    public void testEncodeAndDecode_FilledBodyWithExtFields() throws RemotingCommandException {
        ...
        int code = 103; //org.apache.rocketmq.common.protocol.RequestCode.REGISTER_BROKER
        CommandHeaderCustomizer header = new ExtFieldsHeader();
        RemotingCommand cmd = RemotingCommandHelper.createRequestCommand(code, header);
        ...
        try {
            ...
            CommandHeaderCustomizer decodedHeader = decodedCommand.decodeCommandHeaderCustomizer(ExtFieldsHeader.class);
...
class SampleCommandCustomHeader implements CommandHeaderCustomizer {
    @Override
    public void checkFields() throws RemotingCommandException {
    }
}

class ExtFieldsHeader implements CommandHeaderCustomizer {
