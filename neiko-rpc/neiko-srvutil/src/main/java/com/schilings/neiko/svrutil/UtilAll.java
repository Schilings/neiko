...
public class UtilAll {
	...
	private static final InternalLogger log = InternalLoggerFactory.getLogger(UtilAll.class);
	...
	final static String HOST_NAME = ManagementFactory.getRuntimeMXBean().getName(); // format:
																					// "pid@hostname"
