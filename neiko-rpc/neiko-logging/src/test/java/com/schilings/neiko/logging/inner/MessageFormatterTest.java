...
public class MessageFormatterTest {
	...
	public void formatTest() {
		InnerLoggerFactory.FormattingTuple logging = InnerLoggerFactory.MessageFormatter.format("this is {},and {}",
				"logging", 6546);
		String message = logging.getMessage();
		Assert.assertTrue(message.contains("logging"));

		InnerLoggerFactory.FormattingTuple format = InnerLoggerFactory.MessageFormatter.format("cause exception {}",
				143545, new RuntimeException());
