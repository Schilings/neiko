...
@Intercepts({
		// 在这里拦截的是StatementHandler的Statement prepare(Connection connection, Integer
		// transactionTimeout);
		// Mybatis Plus的TenantLineInnerInterceptor也是在这里入手，
		// 见com.baomidou.mybatisplus.extension.plugins.inner.InnerInterceptor.beforePrepare(StatementHandler
		// sh, Connection connection, Integer transactionTimeout)
