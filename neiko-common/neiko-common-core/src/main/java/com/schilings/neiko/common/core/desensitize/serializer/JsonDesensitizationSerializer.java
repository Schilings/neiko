...
public class JsonDesensitizationSerializer extends JsonSerializer<Object> implements DesensitizationSerializer{
    ...
    public JsonDesensitizationSerializer(Annotation jsonDesensitizeAnnotation, BeanDescription description, BeanFactory beanFactory) {
    ...
    public void serialize(Object value, JsonGenerator jsonGenerator, SerializerProvider serializers) throws IOException {
        if (value instanceof String) {
            ...
            AnnotatedElementKey elementKey = new AnnotatedElementKey(description.getBeanClass().getDeclaredField(fieldName), description.getBeanClass());
