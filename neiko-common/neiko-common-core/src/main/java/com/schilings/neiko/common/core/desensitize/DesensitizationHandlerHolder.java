...
public final class DesensitizationHandlerHolder {
	...
	public static SlideDesensitizationHandler getSlideHandler(
		...
		return (SlideDesensitizationHandler) MAP.computeIfAbsent(handlerClass,
				key -> new DefaultSlideDesensitizationHandler());
	}
	...
	public static RegexDesensitizationHandler getRegexHandler(
		...
		return (RegexDesensitizationHandler) MAP.computeIfAbsent(handlerClass,
				key -> new DefaultRegexDesensitizationHandler());
	}
	...
	public static SimpleDesensitizationHandler getSimpleHandler(
		...
		return (SimpleDesensitizationHandler) MAP.computeIfAbsent(handlerClass,
				key -> new SixAsteriskDesensitizationHandler());
	}
