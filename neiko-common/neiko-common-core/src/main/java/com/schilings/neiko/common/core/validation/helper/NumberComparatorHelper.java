package com.schilings.neiko.common.core.validation.helper;
...
public final class NumberComparatorHelper {
	...
	public static int compare(Number number, long value, OptionalInt treatNanAs) {
		...
		// 1. Floating point numbers should consider nan/infinity as values hence they
		// should
		...
		// 2. For big numbers we don't want to lose any data so we just cast them and call
