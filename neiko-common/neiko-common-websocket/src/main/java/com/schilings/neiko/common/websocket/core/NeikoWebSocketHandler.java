...
import com.schilings.neiko.common.websocket.exception.ErrorJsonMessageException;
...
import com.schilings.neiko.common.websocket.holder.JsonMessageHandlerHolder;
...
@Slf4j
public class NeikoWebSocketHandler extends TextWebSocketHandler {
	...
	public NeikoWebSocketHandler() {
	}

	public NeikoWebSocketHandler(PlanTextMessageHandler planTextMessageHandler) {
