...
public class SecurityUtilsTest {
	...
	//
	// public void testAse() {
	// System.out.println(SecurityUtils.aesEncrypt("key", "ase"));//
	// HX19ChxGmts3l/KkHnWmiw==
	// System.out.println(SecurityUtils.aesEncrypt("HX19ChxGmts3l/KkHnWmiw==", "1001"));//
	// 2dDIszpc8wCAfJHxVtMENw==
	// System.out.println(SecurityUtils.aesEncrypt("HX19ChxGmts3l/KkHnWmiw==",
	// "a123456"));// IOUPsmOqsLY19z8BGidSFA==
	//
