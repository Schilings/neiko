...
public class SecurityUtilsTest {
	...
	public void testAse() {
		...
		System.out.println(check("2dDIszpc8wCAfJHxVtMENw==", "99109f1b0cf6ae9b4572d99fc8bcc0df", null));
		System.out.println(check("IOUPsmOqsLY19z8BGidSFA==", "51f5c2f36d9803ab55d4ba5cee9a3e48", null));
	}
	...
	public void testCustomAse() {
		...
		System.out.println(SecurityUtils.decodeAES("CgoW0TROJmENVc3erSHlEA==", "HX19ChxGmts3l/Kk"));
	}
