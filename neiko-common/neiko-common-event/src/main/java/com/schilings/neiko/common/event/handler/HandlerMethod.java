...
public class HandlerMethod {
	...
	/**
	 * Variant of {@link #HandlerMethod(Object, Method)} that also accepts a
	 * {@link MessageSource} for use from sub-classes.
	 * @since 5.3.10
	 */
	...
	/**
	 * Variant of {@link #HandlerMethod(String, BeanFactory, Method)} that also accepts a
	 * {@link MessageSource}.
	 */
	public HandlerMethod(String beanName, BeanFactory beanFactory, @Nullable MessageSource messageSource,
			Method method) {
	...
	protected class HandlerMethodParameter extends SynthesizingMethodParameter {
		...
		public HandlerMethod.HandlerMethodParameter clone() {
			return new HandlerMethod.HandlerMethodParameter(this);
		}
	...
	private class ReturnValueMethodParameter extends HandlerMethod.HandlerMethodParameter {
		...
		public HandlerMethod.ReturnValueMethodParameter clone() {
			return new HandlerMethod.ReturnValueMethodParameter(this);
		}
