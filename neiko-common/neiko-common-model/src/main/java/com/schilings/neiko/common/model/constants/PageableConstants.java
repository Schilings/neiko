...
public interface PageableConstants {
	 ...
	 * 完整的排序规则正则
	 */
	String SORT_REGEX = "^" + PageableConstants.SORT_FILED_REGEX + "(," + PageableConstants.SORT_FILED_ORDER + ")*$";
	 ...
	 * SQL 关键字
	 */
	Set<String> SQL_KEYWORDS = CollUtil.newHashSet("master", "truncate", "insert", "select", "delete", "update",
