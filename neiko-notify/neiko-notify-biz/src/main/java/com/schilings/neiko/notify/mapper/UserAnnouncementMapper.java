...
import com.schilings.neiko.notify.converter.UserAnnouncementConverter;
...
public interface UserAnnouncementMapper extends ExtendMapper<UserAnnouncement> {
    ...
    default PageResult<UserAnnouncementPageVO> queryPage(PageParam pageParam, UserAnnouncementQO qo) {
        ...
        NeikoLambdaQueryWrapper<Object> queryWrapper = WrappersX.lambdaQueryJoin()
                .selectAll(UserAnnouncement.class)
                .eqIfPresent(UserAnnouncement::getId, qo.getId());
        IPage<UserAnnouncementPageVO> voPage = this.selectJoinPage(page, UserAnnouncementPageVO.class, AUTO_RESULT_MAP, queryWrapper);
