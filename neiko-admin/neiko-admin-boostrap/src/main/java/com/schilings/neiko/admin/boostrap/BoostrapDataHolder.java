...
public class BoostrapDataHolder {
	...
	static {
		...
		if (sysMenuList == null) {
			...
			sysMenuList.add(new SysMenu(10028L, 0L, "个人页", "user", null, "account", 1, "account/settings/Index", 0, 0,
					1, 1, null));
			sysMenuList.add(new SysMenu(10030L, 10028L, "个人设置", null, null, "settings", 1, null, 1, 0, 1, 0, null));
			sysMenuList.add(new SysMenu(10031L, 10030L, "基本设置", null, null, "base", 1, "account/settings/BaseSetting",
					1, 0, 0, 1, null));
			sysMenuList.add(new SysMenu(10032L, 10030L, "安全设置", null, null, "security", 1, "account/settings/Security",
					2, 0, 0, 1, null));
			sysMenuList.add(new SysMenu(10034L, 10030L, "账户绑定", null, null, "binding", 1, "account/settings/Binding", 4,
					0, 0, 1, null));
			sysMenuList.add(new SysMenu(10035L, 10030L, "新消息通知", null, null, "notification", 1,
					"account/settings/Notification", 5, 0, 0, 1, null));
			...
			sysMenuList.add(new SysMenu(100200L, 100000L, "角色管理", null, null, "role", 1, "system/role/SysRolePage", 2,
					0, 0, 1, null));
			sysMenuList.add(
					new SysMenu(100201L, 100200L, "系统角色查询", null, "system:role:read", null, 1, null, 0, 0, 0, 2, null));
			sysMenuList.add(
					new SysMenu(100202L, 100200L, "系统角色新增", null, "system:role:add", null, 1, null, 1, 0, 0, 2, null));
			sysMenuList.add(
					new SysMenu(100203L, 100200L, "系统角色修改", null, "system:role:edit", null, 1, null, 2, 0, 0, 2, null));
			sysMenuList.add(
					new SysMenu(100204L, 100200L, "系统角色删除", null, "system:role:del", null, 1, null, 3, 0, 0, 2, null));
			sysMenuList.add(new SysMenu(100205L, 100200L, "系统角色授权", null, "system:role:grant", null, 1, null, 3, 0, 0,
					2, null));
			sysMenuList.add(new SysMenu(100400L, 100000L, "配置信息", null, null, "config", 1,
					"system/config/SysConfigPage", 6, 0, 0, 1, null));
			sysMenuList.add(
					new SysMenu(100401L, 100400L, "配置查询", null, "system:config:read", null, 1, null, 0, 0, 0, 2, null));
			sysMenuList.add(
					new SysMenu(100402L, 100400L, "配置新增", null, "system:config:add", null, 1, null, 1, 0, 0, 2, null));
			sysMenuList.add(
					new SysMenu(100403L, 100400L, "配置修改", null, "system:config:edit", null, 1, null, 2, 0, 0, 2, null));
			sysMenuList.add(
					new SysMenu(100404L, 100400L, "配置删除", null, "system:config:del", null, 1, null, 3, 0, 0, 2, null));
			sysMenuList.add(new SysMenu(100500L, 100000L, "字典管理", null, null, "dict", 1, "system/dict/SysDictPage", 5,
					0, 0, 1, null));
			sysMenuList.add(
					new SysMenu(100501L, 100500L, "字典查询", null, "system:dict:read", null, 1, null, 0, 0, 0, 2, null));
			sysMenuList.add(
					new SysMenu(100502L, 100500L, "字典新增", null, "system:dict:add", null, 1, null, 1, 0, 0, 2, null));
			sysMenuList.add(
					new SysMenu(100503L, 100500L, "字典修改", null, "system:dict:edit", null, 1, null, 2, 0, 0, 2, null));
			sysMenuList.add(
					new SysMenu(100504L, 100500L, "字典删除", null, "system:dict:del", null, 1, null, 3, 0, 0, 2, null));
			sysMenuList.add(new SysMenu(100700L, 100000L, "组织架构", null, null, "organization", 1,
					"system/organization/SysOrganizationPage", 4, 0, 0, 1, null));
			sysMenuList.add(new SysMenu(100701L, 100700L, "组织架构查询", null, "system:organization:read", null, 1, null, 0,
					0, 0, 2, null));
			sysMenuList.add(new SysMenu(100702L, 100700L, "组织架构新增", null, "system:organization:add", null, 1, null, 1,
					0, 0, 2, null));
			sysMenuList.add(new SysMenu(100703L, 100700L, "组织架构修改", null, "system:organization:edit", null, 1, null, 2,
					0, 0, 2, null));
			sysMenuList.add(new SysMenu(100704L, 100700L, "组织架构删除", null, "system:organization:del", null, 1, null, 3,
					0, 0, 2, null));
			sysMenuList.add(new SysMenu(100705L, 100700L, "组织机构校正", null, "system:organization:revised", null, 1, "", 5,
					0, 0, 2, "校正组织机构层级和深度"));
			sysMenuList.add(new SysMenu(100800L, 100000L, "菜单权限", null, null, "menu", 1, "system/menu/SysMenuPage", 3,
					0, 0, 1, null));
			sysMenuList.add(
					new SysMenu(100801L, 100800L, "菜单权限查询", null, "system:menu:read", null, 1, null, 0, 0, 0, 2, null));
			sysMenuList.add(
					new SysMenu(100802L, 100800L, "菜单权限新增", null, "system:menu:add", null, 1, null, 1, 0, 0, 2, null));
			sysMenuList.add(
					new SysMenu(100803L, 100800L, "菜单权限修改", null, "system:menu:edit", null, 1, null, 2, 0, 0, 2, null));
			sysMenuList.add(
					new SysMenu(100804L, 100800L, "菜单权限删除", null, "system:menu:del", null, 1, null, 3, 0, 0, 2, null));
			sysMenuList.add(new SysMenu(110000L, 0L, "日志管理", "file-search", null, "log", 1, null, 2, 0, 0, 0, null));
			sysMenuList.add(new SysMenu(110100L, 110000L, "操作日志", null, null, "operation-log", 1,
					"log/operation-log/OperationLogPage", 2, 0, 0, 1, null));
			sysMenuList.add(new SysMenu(110101L, 110100L, "操作日志查询", null, "log:operation-log:read", null, 1, null, 0, 0,
					0, 2, null));
			sysMenuList.add(new SysMenu(110200L, 110000L, "登陆日志", null, null, "login-log", 1,
					"log/login-log/LoginLogPage", 1, 0, 0, 1, null));
			sysMenuList.add(new SysMenu(110201L, 110200L, "登陆日志查询", null, "log:login-log:read", null, 1, null, 0, 0, 0,
					2, null));
			sysMenuList.add(new SysMenu(110300L, 110000L, "访问日志", null, null, "access-log", 1,
					"log/access-log/AccessLogPage", 3, 0, 0, 1, null));
			sysMenuList.add(new SysMenu(110301L, 110300L, "访问日志查询", null, "log:access-log:read", null, 1, null, 0, 0, 0,
					2, null));
			sysMenuList.add(new SysMenu(120000L, 0L, "消息通知", "message", null, "notify", 1, null, 3, 0, 0, 0, null));
			sysMenuList.add(new SysMenu(120100L, 120000L, "公告信息", null, null, "announcement", 1,
					"notify/announcement/AnnouncementPage", 1, 0, 0, 1, null));
			sysMenuList.add(new SysMenu(120101L, 120100L, "公告信息查询", null, "notify:announcement:read", null, 1, null, 0,
					0, 0, 2, null));
			sysMenuList.add(new SysMenu(120102L, 120100L, "公告信息新增", null, "notify:announcement:add", null, 1, null, 1,
					0, 0, 2, null));
			sysMenuList.add(new SysMenu(120103L, 120100L, "公告信息修改", null, "notify:announcement:edit", null, 1, null, 2,
					0, 0, 2, null));
			sysMenuList.add(new SysMenu(120104L, 120100L, "公告信息删除", null, "notify:announcement:del", null, 1, null, 3,
					0, 0, 2, null));
			sysMenuList.add(new SysMenu(120200L, 120000L, "用户公告", null, null, "userannouncement", 1,
		...
		if (sysDictList == null) {
			...
			sysDictList
					.add(new SysDict(5L, "operation_type", "操作类型", 1, "6b375bba88f649caa38e95d8e5c5c5c9", "操作日志的操作类型"));
			sysDictList.add(
					new SysDict(6L, "role_type", "角色类型", 1, "90875dc38a154b9d810e8556f8972d9b", "角色类型，系统保留角色不允许删除"));
			sysDictList.add(new SysDict(7L, "dict_value_type", "字典数据类型", 1, "886c8965bdaa4c1e91ffcd5fb20ea84f",
					"Number、String、Boolean"));
			sysDictList.add(
					new SysDict(8L, "login_event_type", "登陆事件类型", 1, "56f191fa64ad42b5948e9dcb331cded9", "1：登陆  2：登出"));
			...
			sysDictList.add(new SysDict(14L, "recipient_filter_type", "消息接收人筛选方式", 1,
					"54f95affca9e4c53aa679bca2855351f", "接收人筛选方式"));
		...
		if (sysDictItemList == null) {
			...
			sysDictItemList.add(new SysDictItem(3L, "log_status", "1", "正常", 1, jsonToMap(
					"{\"tagColor\": \"\", \"languages\": {\"en-US\": \"Normal \", \"zh-CN\": \"正常\"}, \"textColor\": \"#34890A\"}"),
					0, ""));
			sysDictItemList.add(new SysDictItem(4L, "log_status", "0", "异常", 1, jsonToMap(
					"{\"tagColor\": \"\", \"languages\": {\"en-US\": \"Error\", \"zh-CN\": \"异常\"}, \"textColor\": \"#FF0000\"}"),
					1, ""));
			sysDictItemList.add(new SysDictItem(5L, "gender", "1", "男", 1, jsonToMap(
					"{\"tagColor\": \"\", \"languages\": {\"en-US\": \"Male\", \"zh-CN\": \"男\"}, \"textColor\": \"\"}"),
					0, ""));
			sysDictItemList.add(new SysDictItem(6L, "gender", "2", "女", 1, jsonToMap(
					"{\"tagColor\": \"\", \"languages\": {\"en-US\": \"Female\", \"zh-CN\": \"女\"}, \"textColor\": \"\"}"),
					1, ""));
			sysDictItemList.add(new SysDictItem(7L, "gender", "3", "未知", 1, jsonToMap(
					"{\"tagColor\": \"\", \"languages\": {\"en-US\": \"Unknown\", \"zh-CN\": \"未知\"}, \"textColor\": \"\"}"),
					2, ""));
			sysDictItemList.add(new SysDictItem(8L, "grant_types", "password", "密码模式", 1, jsonToMap("{}"), 0, null));
			sysDictItemList.add(
					new SysDictItem(9L, "grant_types", "authorization_code", "授权码模式", 1, jsonToMap("{}"), 1, null));
			sysDictItemList.add(
					new SysDictItem(10L, "grant_types", "client_credentials", "客户端模式", 1, jsonToMap("{}"), 2, null));
			sysDictItemList
					.add(new SysDictItem(11L, "grant_types", "refresh_token", "刷新模式", 1, jsonToMap("{}"), 3, null));
			sysDictItemList.add(new SysDictItem(12L, "grant_types", "implicit", "简化模式", 1, jsonToMap("{}"), 4, null));
			sysDictItemList.add(new SysDictItem(13L, "login_event_type", "1", "登陆", 1, jsonToMap(
					"{\"tagColor\": \"cyan\", \"languages\": {\"en-US\": \"Login\", \"zh-CN\": \"登陆\"}, \"textColor\": \"\"}"),
					0, ""));
			sysDictItemList.add(new SysDictItem(14L, "login_event_type", "2", "登出", 1, jsonToMap(
					"{\"tagColor\": \"pink\", \"languages\": {\"en-US\": \"Logout\", \"zh-CN\": \"登出\"}, \"textColor\": \"\"}"),
					1, ""));
			sysDictItemList.add(new SysDictItem(15L, "operation_type", "3", "查看", 1, jsonToMap(
					"{\"tagColor\": \"purple\", \"languages\": {\"en-US\": \"Read\", \"zh-CN\": \"查看\"}, \"textColor\": \"\"}"),
					3, ""));
			sysDictItemList.add(new SysDictItem(16L, "operation_type", "4", "新建", 1, jsonToMap(
					"{\"tagColor\": \"cyan\", \"languages\": {\"en-US\": \"Create\", \"zh-CN\": \"新建\"}, \"textColor\": \"\"}"),
					4, ""));
			sysDictItemList.add(new SysDictItem(17L, "operation_type", "5", "修改", 1, jsonToMap(
					"{\"tagColor\": \"orange\", \"languages\": {\"en-US\": \"Update\", \"zh-CN\": \"修改\"}, \"textColor\": \"\"}"),
					5, ""));
			sysDictItemList.add(new SysDictItem(18L, "operation_type", "6", "删除", 1, jsonToMap(
					"{\"tagColor\": \"pink\", \"languages\": {\"en-US\": \"Delete\", \"zh-CN\": \"删除\"}, \"textColor\": \"\"}"),
					6, ""));
			sysDictItemList.add(new SysDictItem(19L, "role_type", "1", "系统", 1, jsonToMap(
					"{\"tagColor\": \"orange\", \"languages\": {\"en-US\": \"System\", \"zh-CN\": \"系统\"}, \"textColor\": \"\"}"),
					1, "系统角色不能删除"));
			sysDictItemList.add(new SysDictItem(20L, "role_type", "2", "自定义", 1, jsonToMap(
					"{\"tagColor\": \"green\", \"languages\": {\"en-US\": \"Custom\", \"zh-CN\": \"自定义\"}, \"textColor\": \"\"}"),
					2, "自定义角色可以删除"));
			...
			sysDictItemList.add(new SysDictItem(27L, "yes_or_no", "1", "是", 1, jsonToMap(
					"{\"tagColor\": \"\", \"languages\": {\"en-US\": \"Yes\", \"zh-CN\": \"是\"}, \"textColor\": \"\"}"),
					1, null));
			sysDictItemList.add(new SysDictItem(28L, "yes_or_no", "0", "否", 1, jsonToMap(
					"{\"tagColor\": \"\", \"languages\": {\"en-US\": \"No\", \"zh-CN\": \"否\"}, \"textColor\": \"\"}"),
					2, null));
			sysDictItemList.add(new SysDictItem(49L, "user_type", "1", "系统用户", 1, jsonToMap(
					"{\"tagColor\": \"\", \"languages\": {\"en-US\": \"System User\", \"zh-CN\": \"系统用户\"}, \"textColor\": \"\"}"),
					1, null));
			sysDictItemList.add(new SysDictItem(50L, "recipient_filter_type", "1", "全部", 1, jsonToMap(
					"{\"tagColor\": \"\", \"languages\": {\"en-US\": \"All\", \"zh-CN\": \"全部\"}, \"textColor\": \"\"}"),
					1, "不筛选，对全部用户发送"));
			sysDictItemList.add(new SysDictItem(51L, "recipient_filter_type", "2", "指定角色", 1, jsonToMap(
					"{\"tagColor\": \"\", \"languages\": {\"en-US\": \"Specify the role\", \"zh-CN\": \"指定角色\"}, \"textColor\": \"\"}"),
					2, "筛选拥有指定角色的用户"));
			sysDictItemList.add(new SysDictItem(52L, "recipient_filter_type", "3", "指定组织", 1, jsonToMap(
					"{\"tagColor\": \"\", \"languages\": {\"en-US\": \"Specify the organization\", \"zh-CN\": \"指定组织\"}, \"textColor\": \"\"}"),
					3, "筛选指定组织的用户"));
			sysDictItemList.add(new SysDictItem(53L, "recipient_filter_type", "4", "指定类型", 1, jsonToMap(
					"{\"tagColor\": \"\", \"languages\": {\"en-US\": \"Specify the type\", \"zh-CN\": \"指定类型\"}, \"textColor\": \"\"}"),
					4, "筛选指定用户类型的用户"));
			sysDictItemList.add(new SysDictItem(54L, "recipient_filter_type", "5", "指定用户", 1, jsonToMap(
					"{\"tagColor\": \"\", \"languages\": {\"en-US\": \"Specify the user\", \"zh-CN\": \"指定用户\"}, \"textColor\": \"\"}"),
					5, "指定用户发送"));
			sysDictItemList.add(new SysDictItem(55L, "notify_channel", "1", "站内", 1, jsonToMap(
					"{\"tagColor\": \"\", \"languages\": {\"en-US\": \"Station\", \"zh-CN\": \"站内\"}, \"textColor\": \"\"}"),
					1, null));
			sysDictItemList.add(new SysDictItem(56L, "notify_channel", "2", "短信", 1, jsonToMap(
					"{\"tagColor\": \"\", \"languages\": {\"en-US\": \"SMS\", \"zh-CN\": \"短信\"}, \"textColor\": \"\"}"),
					2, null));
			sysDictItemList.add(new SysDictItem(57L, "notify_channel", "3", "邮箱", 1, jsonToMap(
					"{\"tagColor\": \"\", \"languages\": {\"en-US\": \"Email\", \"zh-CN\": \"邮箱\"}, \"textColor\": \"\"}"),
					3, null));
			sysDictItemList.add(new SysDictItem(59L, "menu_type", "0", "目录", 1, jsonToMap(
					"{\"tagColor\": \"\", \"languages\": {\"en-US\": \"Catalog\", \"zh-CN\": \"目录\"}, \"textColor\": \"\"}"),
					1, null));
			sysDictItemList.add(new SysDictItem(60L, "menu_type", "1", "菜单", 1, jsonToMap(
					"{\"tagColor\": \"\", \"languages\": {\"en-US\": \"Menu\", \"zh-CN\": \"菜单\"}, \"textColor\": \"\"}"),
					2, null));
			sysDictItemList.add(new SysDictItem(61L, "menu_type", "2", "按钮", 1, jsonToMap(
					"{\"tagColor\": \"\", \"languages\": {\"en-US\": \"Button\", \"zh-CN\": \"按钮\"}, \"textColor\": \"\"}"),
					3, null));
			sysDictItemList.add(new SysDictItem(62L, "operation_type", "0", "其他", 1, jsonToMap(
					"{\"tagColor\": \"\", \"languages\": {\"en-US\": \"Other\", \"zh-CN\": \"其他\"}, \"textColor\": \"\"}"),
					0, null));
			sysDictItemList.add(new SysDictItem(63L, "operation_type", "1", "导入", 1, jsonToMap(
					"{\"tagColor\": \"green\", \"languages\": {\"en-US\": \"Import\", \"zh-CN\": \"导入\"}, \"textColor\": \"\"}"),
					1, null));
			sysDictItemList.add(new SysDictItem(64L, "operation_type", "2", "导出", 1, jsonToMap(
					"{\"tagColor\": \"blue\", \"languages\": {\"en-US\": \"Export\", \"zh-CN\": \"导出\"}, \"textColor\": \"\"}"),
					2, null));
			sysDictItemList.add(new SysDictItem(65L, "user_status", "0", "锁定", 1, jsonToMap(
					"{\"tagColor\": \"#d9d9d9\", \"languages\": {\"en-US\": \"Locked\", \"zh-CN\": \"锁定\"}, \"textColor\": \"#d9d9d9\", \"badgeStatus\": \"default\"}"),
					2, null));
			sysDictItemList.add(new SysDictItem(66L, "user_status", "1", "正常", 1, jsonToMap(
					"{\"tagColor\": \"blue\", \"languages\": {\"en-US\": \"Normal\", \"zh-CN\": \"正常\"}, \"textColor\": \"#5b8ff9\", \"badgeStatus\": \"processing\"}"),
					1, null));
		}
	}
